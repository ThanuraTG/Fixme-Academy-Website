...
<!-- body part -->
    <div class="soft">
        <div class="coverpic">
            <img src="../image/accunting 2.jpg" alt="">
            <h2>BACHELOR OF MANAGEMENT HONOURS IN ACCOUNTING</h2>
        </div>
        <div class="sof1">
            <div class="head">
                <h3>What is </h3>
                <h1>Accounting?</h1>
                <img src="../image/accunting 1.jpg" alt="">
            </div>
            <div class="bod">
                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;The Department of Accounting provides the Bachelor of Management Honours in Accounting, a comprehensive program designed to build expertise in financial reporting, auditing, taxation, and corporate finance. This UGC-approved degree integrates academic rigor with practical applications through case studies and accounting software training. With strategic partnerships with ACCA, CIMA, and PwC, students benefit from subject exemptions, scholarships, and industry recognition. Graduates are prepared for careers as auditors, tax consultants, financial analysts, and management accountants, both locally and abroad.</p>
            </div>
        </div>
        <div class="sof2">
