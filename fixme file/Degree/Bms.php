...
<!-- body part -->
    <div class="soft">
        <div class="coverpic">
            <img src="../image/biomedical 2.jpg" alt="" style="filter: brightness(60%);">
            <h2>BSc HONOURS IN BIOMEDICAL SCIENCE</h2>
        </div>
        <div class="sof1">
            <div class="head">
                <h3>What is </h3>
                <h1>Biomedical Science?</h1>
                <img src="../image/biomedical 1.png" alt="">
            </div>
            <div class="bod">
                <P>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;The Bachelor of Science Honours in Biomedical Science is a research-driven program that explores life at the cellular and molecular levels. Students study human biology, molecular pathology, genetics, microbiology, and clinical diagnostics while gaining practical lab experience in Sri Lanka’s best-equipped undergraduate biomedical laboratories.</P>
                <P>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;With a final-year research project and modules aligned with global biomedical standards, this program prepares graduates for diverse careers as medical researchers, laboratory technologists, microbiologists, or lecturers. KIU’s strong industry ties and exceptional lab infrastructure ensure students graduate ready for work in research institutions, healthcare settings, or academia.</P>
            </div>
        </div>
        <div class="sof2">
            <h3>Entry Requirements</h3>
            <ul>
                <li>Three Passes in GCE Advanced Level (A/L) in Biological Science Stream</li>
                <li>Equivalent international qualifications approved by the Ministry of Higher Education</li>
            </ul>
        </div>
