...
<!-- body part -->
    <div class="dep">
        <div class="coverpic">
            <img src="../image/helth head.jpg" alt="">
            <h2>DEPARTMENT OF HEALTH SCIENCES</h2>
        </div>
        <div class="programmes">
            <h3>DEPARTMENT</h3>
            <div class="degree1">
                <img src="../image/helth acupunture.jpg" alt="">
                <h4>Department of Medical Science in Acupuncture</h4>
                <P style="text-align: center;">BSc (Hons) in Medical Science in Acupuncture – Bridging Tradition and Modern Science</P>
                <button><a href="../Degree/Acupunture.php">LEARN MORE</a></button>
            </div>
            <div class="degree1">
                <img src="../image/helth bio.jpg" alt="">
                <h4>Department of <br>Biomedical Science</h4>
                <P style="text-align: center;">BSc (Hons) in Biomedical Science – Driving the Future of Medical Research</P>
                <button><a href="../Degree/Bms.php">LEARN MORE</a></button>
            </div>
        </div>
    </div>
