...
<!-- body part -->
    <div class="soft">
        <div class="coverpic">
            <img src="../image/human 2.jpg" alt="">
            <h2>BACHELOR OF MANAGEMENT HONOURS IN HUMAN RESOURCE</h2>
        </div>
        <div class="sof1">
            <div class="head">
                <h3>What is </h3>
                <h1>Human Resource?</h1>
                <img src="../image/human 1.jpg" alt="">
            </div>
            <div class="bod">
                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;The Department of Human Resource offers the Bachelor of Management Honours in Human Resource, a four-year UGC-recognized degree that blends theory with hands-on training. The curriculum covers core HR functions such as recruitment, performance management, organizational behavior, and labor law. Students gain real-world insights through internships and case studies, preparing for roles in HR strategy, employee relations, and talent management. With exposure to industry trends like HR analytics and digital transformation, graduates are equipped to meet the workforce challenges of the future.</p>
            </div>
        </div>
        <div class="sof2">
