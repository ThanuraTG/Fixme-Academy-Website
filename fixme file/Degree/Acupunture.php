...
<!-- body part -->
    <div class="soft">
        <div class="coverpic">
            <img src="../image/acupunture 2.jpg" alt="">
            <h2>BSc HONOURS IN MEDICAL SCIENCE IN ACUPUNCTURE</h2>
        </div>
        <div class="sof1">
            <div class="head">
                <h3>What is </h3>
                <h1>Medical Science in Acupuncture?</h1>
                <img src="../image/acupunture 1.jpg" alt="">
            </div>
            <div class="bod">
                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;This pioneering program combines the rich history of traditional acupuncture with the rigor of modern medical science. Recognized by the UGC and MOHE, the degree provides students with in-depth theoretical knowledge and extensive clinical training. With a curriculum aligned to WHO standards, students gain the skills needed to diagnose, treat, and manage various health conditions through acupuncture.</p>
                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Graduates are prepared for global careers as licensed acupuncturists, integrative health practitioners, or clinical researchers. The program includes hands-on experience at KIU’s fully functional acupuncture clinic, fostering both technical proficiency and patient-centered care.</p>
            </div>
        </div>
        <div class="sof2">
