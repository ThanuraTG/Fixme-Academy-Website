...
<!-- body part -->
    <div class="soft">
        <div class="coverpic">
            <img src="../image/marketing 2.jpg" alt="" style="filter: brightness(60%);">
            <h2>BACHELOR OF MANAGEMENT HONOURS IN MARKETING</h2>
        </div>
        <div class="sof1">
            <div class="head">
                <h3>What is </h3>
                <h1>Marketing?</h1>
                <img src="../image/marketing 1.jpg" alt="">
            </div>
            <div class="bod">
                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;This program delivers in-demand marketing skills through a dynamic curriculum covering digital marketing, consumer behavior, advertising, brand management, and marketing analytics. The Department of Marketing equips students with the strategic thinking and communication skills required to thrive in competitive industries. Practical experience is gained through live projects, industry workshops, and internships. Collaborations with SLIM and other partners ensure students gain exposure to real-world challenges and industry certifications, preparing them for impactful careers in marketing and communications.</p>
            </div>
        </div>
        <div class="sof2">
